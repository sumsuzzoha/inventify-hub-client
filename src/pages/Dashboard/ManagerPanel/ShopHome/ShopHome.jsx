...
const ShopHome = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-blue-500 p-4 mb-2 md:text-left md:flex justify-between items-center rounded-lg gap-1  mx-auto ">

                <div className="bg-white border rounded-lg overflow-hidden shadow-md m-4 p-6 w-9/12 md:w-64 h-44 mx-auto">
                ...
                <div className="bg-white border rounded-lg overflow-hidden shadow-md m-4 p-6 w-9/12 md:w-64 h-44 mx-auto text-center">
